      ...
      <div className="px-6 py-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <button
                ...
                className="w-full px-4 py-2.5 text-left bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 flex items-center justify-between hover:bg-gray-50 transition-colors"
              >
                <span className="text-gray-900 truncate">{selectedProject}</span>
                <ChevronDown className={`h-4 w-4 text-gray-400 transition-transform flex-shrink-0 ml-2 ${isDropdownOpen ? 'rotate-180' : ''}`} />
              </button>
                ...
                <div className="absolute z-20 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg max-h-60 overflow-auto">
                  {projects.map((project) => (
                    <button
                      ...
                      className="w-full px-4 py-2.5 text-left hover:bg-gray-50 focus:outline-none focus:bg-gray-50 first:rounded-t-md last:rounded-b-md transition-colors"
                    >
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <div className="flex items-center px-4 py-2.5 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 transition-colors">
                <button
                  onClick={handleCalendarClick}
                  className="flex items-center hover:bg-gray-100 rounded p-1 transition-colors -ml-1"
                >
                  <Calendar className="h-4 w-4 text-gray-400 cursor-pointer" />
                </button>
                <span className="text-gray-900 ml-2">{formatDateRange()}</span>
              </div>
