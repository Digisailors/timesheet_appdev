  ...
  const confirmDelete = () => {
    if (currentDesignationIndex !== null) {
      const updatedDesignations = designations.filter(
        (_, index) => index !== currentDesignationIndex
      );
      setDesignations(updatedDesignations);
    }
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300"
              >
